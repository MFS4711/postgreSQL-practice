...
# Classes need to be after executing instructions to connect to database and before session created
...
# session.query(...) - accesses the particular class
...
# filter_by(colName = "valueWanted") - get the row of data that the value appears in 
# first() - to ensure first instance is shown only

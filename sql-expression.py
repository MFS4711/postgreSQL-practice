...
with db.connect() as connection:
    ...
    # Seem like with_only_columns() - contents are ["table variable".c."column name"] - gives all column contents
    # Query 2 - select only the "Name" column from the "Artist" table
    # select_query = artist_table.select().with_only_columns([artist_table.c.Name])

    # Seems like .where() - contents are ("table variable".c."column name" == "column value") - gives a specific
